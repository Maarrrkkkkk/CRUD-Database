...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sourceDir = '/path/to/backup/files/'; // Replace with the actual source directory path
    $backupDir = '/path/to/store/backups/'; // Replace with the actual backup directory path
